...
from database.connections_mdb import active_connection, all_connections, delete_connection, if_active, make_active, \
    make_inactive
from info import ADMINS, AUTH_CHANNEL, AUTH_USERS, SUPPORT_CHAT_ID, SUPPORT_CHAT, CUSTOM_FILE_CAPTION, PICS, AUTH_GROUPS, P_TTI_SHOW_OFF, LOG_CHANNEL, SPELL_IMG, MAX_B_TN, IMDB, \
...
if not_joined:
    ...
    async def auto_filter(client, msg, spoll=False):
        ...
        if not spoll:
            ...
            if re.findall("((^\/|^,|^!|^\.|^[\U0001F120-\U000E007F]).*)", message.text):
                return
